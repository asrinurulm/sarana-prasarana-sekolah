            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li ><a href="{{ route('peminjam') }}"><i class="fa fa-home"></i> Home</a></li>
                  <li><a href="{{ route('pinjampeminjam') }}"><i class="fa fa-clipboard"></i> Form Peminjaman </a></li>
                  <li><a href="{{ route('laporr') }}""><i class="fa fa-book"></i> Laporan </a></li>
                </ul>
              </div>
